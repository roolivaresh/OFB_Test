 ...
 *  @author mfrojas
 */
public class ModCSARequi implements ModelValidator
{
	/**
	 *	Constructor.
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModCSARequi.class);
	/** Client			*/
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		{
			//Rodrigo Olivares Hurtado 2023-08-29 se toma en cuenta el cambio de moneda
			...
			if(CurrencyID == 228) {//CLP
				...
				//Rodrigo Olivares Hurtado Updated valueasString 2023-08-30
				GrandTotal = new BigDecimal(req.get_ValueAsString("CurrencyCLP"));
			}

			if(po.get_ValueOld("DocStatus").equals("AF") && req.getDocStatus().equals("VS")
					&& GrandTotal.compareTo(new BigDecimal(1000000))>=0)
				//Rodrigo Olivares Hurtado 2023-08-17 actualización del mensaje
				throw new AdempiereException("El total es mayor o igual a $1.000.000, pasar por el estado '50 Aprobación de Compra Gerencia'");

			if(po.get_ValueOld("DocStatus").equals("AF") && req.getDocStatus().equals("AG")
					&& GrandTotal.compareTo(new BigDecimal(1000000))<0)
				//Rodrigo Olivares Hurtado 2023-08-17 actualización del mensaje
				throw new AdempiereException("El total es menor a $1.000.000, pasar por el estado '70 Validación de Solicitud de Compra'");
		}
