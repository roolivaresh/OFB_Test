...
import org.adempiere.core.domains.models.I_M_RequisitionTax;
...
public class MRequisition extends X_M_Requisition implements DocAction
{
	...
	public List<MRequisitionTax> getTaxes(boolean requery)
	{
		if (taxes != null && !requery)
			return taxes;
		taxes = new Query(getCtx(), I_M_RequisitionTax.Table_Name, "M_Requisition_ID = ?", get_TrxName())
				.setParameters(get_ID())
				.list();
		return taxes;
	}	//	getTaxes
	...
	//Rodrigo Olivares Hurtado 2023-09-08
