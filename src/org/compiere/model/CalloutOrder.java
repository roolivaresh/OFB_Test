...
public class CalloutOrder extends CalloutEngine
{
	...
	public String bPartner (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		String sql = "SELECT p.AD_Language,p.C_PaymentTerm_ID,"
				+ " COALESCE(p.M_PriceList_ID,g.M_PriceList_ID) AS M_PriceList_ID,p.M_PriceList_Version_ID, "
		...
		try
		{
			...
			if (rs.next())
			{
				...
				{
					// 05-10-2023 se comenta para que no cambie el vendedor y pueda usar caja chica
				...
				//04-10-2023 JLeyton se agrega version de lista de precio al callout
				//tarea=> https://redbooth.com/a/#!/projects/986995/tasks/58095999
				Integer iiv = Integer.valueOf(rs.getInt(IsSOTrx ? "M_PriceList_Version_ID" : "M_PriceList_Version_ID"));
				if (!rs.wasNull()) {
					mTab.setValue("M_PriceList_ID", ii);
					mTab.setValue("M_PriceList_Version_ID",iiv );
				}
				else
				{	//05-10-2023 JLeyton se quita actualizacion por lista de precio por defecto
	...
	public String priceList (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		//16-10-2023 JLeyton se deja nulo el campo version de lista de precio cuando se cambia la lista de precio
	...
	public String product (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		/*  se comenta porque mostraba 2 veces el mesnaje de stock 
	...
	public String qty (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		//	Storage
		//04-10-2023 JLeyton se agrega validacion para poder desactivar mensaje de stock
		//tarea=> https://redbooth.com/a/#!/projects/986995/tasks/58095820
		String stockPopUp = (MSysConfig.getValue("StockCalloutOn")==null?"Y":MSysConfig.getValue("StockCalloutOn"));
		if(stockPopUp.equals("Y")){
			if (M_Product_ID != 0 
	...
	public String genericCode(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value) {
		
		int M_Product_ID=(int)DB.getSQLValue(null,"SELECT max(m_product_id) FROM M_Product_PO WHERE VendorProductNo=?",mTab.get_ValueAsString("VendorProductNo"));
		if(M_Product_ID>0)
