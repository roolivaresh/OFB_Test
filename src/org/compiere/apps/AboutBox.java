...
public final class AboutBox extends CDialog implements ActionListener
{
	...
	private JLabel ofbVersion = new JLabel();//OFB version
	...
	private void jbInit() throws Exception
	{
		 ...
		 * ininoles OFB
		 * set OFB version*/
		ofbVersion.setForeground(Color.blue);
		ofbVersion.setHorizontalAlignment(SwingConstants.CENTER);
		ofbVersion.setHorizontalTextPosition(SwingConstants.CENTER);
		ofbVersion.setText(OFBVersion);
		...
		headerPanel.add(ofbVersion, null);//ininoles OFB version
